...
league_standings = (
    "Overall standings for the chosen week. Dynamically adjusts information based on whether a league "
...
league_median_matchup_standings = (
    'Overall "against the median" league standings. Every week the median score is '
...
playoff_probabilities = (
    "Predicts each team's likelihood of making the playoffs, as well as of finishing in any "
...
team_power_rankings = (
    "The power rankings are calculated by taking a weekly average of each team's score, coaching "
    "efficiency, and luck."
)

team_z_score_rankings = (
    "Measure of standard deviations away from mean for a score. Shows teams performing above or "
...
team_score_rankings = (
    "Teams ranked by highest score. If tie-breaks are turned on, highest bench points will be used "
    "to break score ties."
)

team_coaching_efficiency_rankings = (
    "Coaching efficiency is calculated by dividing the total points scored by each "
...
team_luck_rankings = (
    "Luck is calculated by matching up each team against every other team that week to get a total "
...
beef_rankings = (
    'The Beef ranking is a "just-for-fun" metric with a made-up unit of measurement, the '
...
covid_19_risk = (
    'The COVID-19 risk ranking is a "just-for-fun" metric that pulls NFL player transaction history '
...
weekly_highest_coaching_efficiency = (
    "Running list of each week's team with the highest coaching efficiency. Can be "
